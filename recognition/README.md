...
![Siamese Network Architecture]("Siamese Melanoma Classification"/images/Architecture.png)
...
To reproduce the results reported in this README:
...
Expected test accuracy: **81.56% ± 0.0%** (identical across runs with same seed)
